...
INPLAY_ASSETS = [
...

        {
            ...
            'size': [[lambda : round(np.random.uniform(*[0.3, 0.3]), 2), lambda: round(np.random.uniform(*[0.3, 1.2]), 2), lambda: 0.4], [lambda: round(np.random.uniform(*[0.3, 0.3]), 2), lambda: round(np.random.uniform(*[.3, 1.7]), 2), lambda: 0.4]][::-1], 
        ...
        # {
        #     'name': ['fixed_block_test'],
        #     'size': [[lambda : round(np.random.uniform(*[0.3, 0.3]), 2), lambda: round(np.random.uniform(*[0.3, 1.3]), 2), lambda: 0.4]],
        #     'pos': [[round(np.random.uniform(*[world_cfg.movable_block.pos_x_range[0], world_cfg.movable_block.pos_x_range[1]]), 2), round(np.random.uniform(*world_cfg.fixed_block.pos_y_range), 2), 0.2]],
        #     'density': [10000]
        # },
...
TASK_0 = [
        ...
        {
            'name': ['fixed_block_1', 'movable_block_1'][::-1],
            'size': [[lambda : round(np.random.uniform(*[0.3, 0.3]), 2), lambda: round(np.random.uniform(*[0.3, 0.8]), 2), lambda: 0.4], [lambda: round(np.random.uniform(*[0.3, 0.3]), 2), lambda: round(np.random.uniform(*[0.3, 1.7]), 2), lambda: 0.4]][::-1], 
            'pos': [[round(np.random.uniform(*world_cfg.fixed_block.pos_x_range), 2), round(np.random.uniform(*world_cfg.fixed_block.pos_y_range), 2), 0.2], [round(np.random.uniform(*world_cfg.movable_block.pos_x_range), 2), round(np.random.uniform(*world_cfg.movable_block.pos_y_range), 2), 0.2]][::-1],
            'density': [10000, 8][::-1]
        },
        ...
        # {
        #     'name': ['fixed_block_3', 'movable_block_3'][::-1],
        #     'size': [[lambda : round(np.random.uniform(*[0.3, 0.3]), 2), lambda: round(np.random.uniform(*[0.3, 0.8]), 2), lambda: 0.4], [lambda: round(np.random.uniform(*[0.3, 0.3]), 2), lambda: round(np.random.uniform(*[1.3, 1.7]), 2), lambda: 0.4]][::-1], 
        #     'pos': [[round(np.random.uniform(*world_cfg.fixed_block.pos_x_range), 2), round(np.random.uniform(*world_cfg.fixed_block.pos_y_range), 2), 0.2], [round(np.random.uniform(*world_cfg.movable_block.pos_x_range), 2), round(np.random.uniform(*world_cfg.movable_block.pos_y_range), 2), 0.2]][::-1],
        #     'density': [10000, 8][::-1]
        # },
        ...
        # {
        #     'name': ['fixed_block_4', 'movable_block_4'][::-1],
        #     'size': [[lambda : round(np.random.uniform(*[0.3, 0.3]), 2), lambda: round(np.random.uniform(*[0.3, 0.8]), 2), lambda: 0.4], [lambda: round(np.random.uniform(*[0.3, 0.3]), 2), lambda: round(np.random.uniform(*[1.3, 1.7]), 2), lambda: 0.4]][::-1], 
        #     'pos': [[round(np.random.uniform(*world_cfg.fixed_block.pos_x_range), 2), round(np.random.uniform(*world_cfg.fixed_block.pos_y_range), 2), 0.2], [round(np.random.uniform(*world_cfg.movable_block.pos_x_range), 2), round(np.random.uniform(*world_cfg.movable_block.pos_y_range), 2), 0.2]][::-1],
        #     'density': [10000, 8][::-1]
        # }
...
TASK_1 = [
        {
            ...
            'size': [[lambda:0.3, lambda:0.8, lambda: 0.4], [lambda:0.3, lambda:0.4, lambda: 0.4], [lambda:0.3, lambda:0.9, lambda: 0.4]][::-1],
            'pos': [[1.5, 0.5, 0.2], [2.25, -0.15, 0.2], [1.5, -0.4, 0.2]][::-1],
            'density': [10000, 10000, 8][::-1]
        },
        
        {
            ...
            'size': [[lambda: 0.3, lambda: 0.8, lambda: 0.4], [lambda: 0.3, lambda: 0.4, lambda: 0.4], [lambda: 0.3, lambda: 0.9, lambda: 0.4]][::-1],
            'pos': [[1.5, 0.5, 0.2], [2.25, -0.6, 0.2], [1.5, -0.4, 0.2]][::-1],
            'density': [10000, 10000, 8][::-1]
        },
...
TASK_2 = [
        {
            ...
            'size':  [[lambda: 0.3, lambda: 0.8, lambda: 0.4], [lambda: 0.3, lambda: 0.6, lambda: 0.4], [lambda: 0.3, lambda: 1.6, lambda: 0.4]][::-1],
            'pos': [[1.3, 0.5, 0.2], [2.1, -0.5, 0.2], [.6, 0.0, 0.2]][::-1],
            'density': [10000, 10000, 8][::-1]
        },
...
TASK_4 = [
    {
        ...
        'size': [[lambda: 0.3, lambda: 0.7, lambda: 0.4], [lambda: 0.3, lambda: 0.7, lambda: 0.4], [lambda: 0.3, lambda: 0.8, lambda: 0.4]][::-1],
        'pos': [[1.2, -(0.93-0.35), 0.2], [1.2, (0.93-0.35), 0.2], [0.85, 0.0, 0.2]][::-1],
        'density': [10000, 10000, 8][::-1]
    },
]
...
INPLAY_ASSETS = [*TASK_0, *TASK_1]
# INPLAY_ASSETS = [*TASK_6] 
EVAL_INPLAY_ASSETS = [*TASK_0, *TASK_1]
